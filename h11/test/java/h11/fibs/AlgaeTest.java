...
public abstract class AlgaeTest {
    ...
    public void testAlgaeGeneratesFibs(int numberOfFibs) {
        List<Integer> fibonacciList = fibonacciGenerator.generate(numberOfFibs);
        List<Integer> algaeFibonacciList = algaeFibonacciGenerator.generate(numberOfFibs);


        Assertions.assertEquals(fibonacciList, algaeFibonacciList);
